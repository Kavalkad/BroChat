...
export const Message = ({ messageInfo, currentUser }) => {
  ...
  return (
    <Flex direction="column" mb={4} w="full" align={isSelf ? "flex-end" : "flex-start"}>
      <Flex align="center" gap={2} mb={1} px={1} maxW="80%">
        <Text fontSize="xs" fontWeight="bold" color={isSelf ? "cyan.400" : "blue.400"}>
      ...
      <Box
        ...
        shadow="lg"
        bg={isSelf ? "linear-gradient(135deg, #00b4d8 0%, #0077b6 100%)" : "whiteAlpha.100"}
        color="white"
